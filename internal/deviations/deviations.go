...
var (
	...
	RoutePolicyUnderPeerGroup = flag.Bool("deviation_rpl_under_peergroup", true, "Device requires route-policy configuration under bgp peer-group. Fully-compliant devices should pass with and without this deviation.")
	...
	VerifyBGPNotEstablished = flag.Bool("deviation_bgp_not_established", false, "aj")
)
